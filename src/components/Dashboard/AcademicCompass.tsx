  ...
  return (
    <div className="bg-gradient-to-b from-[#7B5B75] to-[#594255] rounded-lg p-6 text-white flex flex-col justify-between items-center text-center shadow-md w-full">
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="font-sister text-xl font-normal leading-tight tracking-wide">
          Academic Compass
        </h2>
      </div>
      ...
      {/* Action Button */}
      <button className="mt-6 w-full py-3.5 px-6 font-sister bg-white text-[#594255] rounded-full text-lg font-medium flex items-center justify-center gap-2 hover:bg-white/95 transition-all shadow-sm active:scale-[0.98]">
